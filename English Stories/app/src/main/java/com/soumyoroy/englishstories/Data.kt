...
// This is the data source of our application
object Data {

    // Creating array by using instances of story class
    val stories = arrayOf(
        Story("1. The Lion and the Mouse", "A lion was once sleeping in the jungle when a mouse started running up and down his body just for fun. This disturbed the lion’s sleep, and he woke up quite angry. He was about to eat the mouse when the mouse desperately requested the lion to set him free. “I promise you, I will be of great help to you someday if you save me.” The lion laughed at the mouse’s confidence and let him go.\n" +
                "\n" +
        ...
        Story("2. Count Wisely", "One day, king Akbar asked a question in his court that left everyone in the courtroom puzzled. As they all tried to figure out the answer, Birbal walked in and asked what the matter was. They repeated the question to him.\n" +
        ...
        Story("6. The Milkmaid and Her Pail", "Patty, a milkmaid milked her cow and had two full pails of fresh, creamy milk. She put both pails of milk on a stick and set off to the market to sell the milk. As she took steps towards the market, her thoughts took steps towards wealth. On her way, she kept thinking about the money she would make from selling the milk. Then she thought about what she would do with that money.\n" +
                "\n" +
        ...
        Story("9. The Tale of the Pencil", "A boy named Raj was upset because he had done poorly in his English test. He was sitting in his room when his grandmother came and comforted him. His grandmother sat beside him and gave him a pencil. Raj looked at his grandma puzzled, and said he didn’t deserve a pencil after his performance in the test.\n" +
                "\n" +
        ...
        Story("20. The Greedy Lion", "On a hot day, a lion in the forest started feeling hungry. He was starting to hunt for his food when he found a hare roaming around alone. Instead of catching the hare, the lion let it go – “A small hare such as this can’t satisfy my hunger”, he said and scoffed. Then, a beautiful deer passed by and he decided to take his chances – he ran and ran behind the deer but since he was weak because of the hunger, he struggled to keep up with the deer’s speed. Tired and defeated, the lion went back to look for the hare to fill up his stomach for the time being, but it was gone. The lion was sad and remained hungry for a long time.\n" +
                "\nMoral of the Story :" +
                "\n" +
